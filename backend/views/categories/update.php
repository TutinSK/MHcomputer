<section class="content">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        <div class=" col-lg-6">
            <label>Tên :</label>
            <input type="text" name="name"  value="<?php echo isset($_POST['update'])?$_POST['name']:$category['name_category']?>"
                   class="form-control" placeholder="Tên Danh Mục"/>
        </div>
        <div class=" col-lg-6">
            <label >Mô Tả:</label>
            <input type="text" name="description"  value="<?php echo isset($_POST['themmoi'])?$_POST['description']:$category['description']?>"
