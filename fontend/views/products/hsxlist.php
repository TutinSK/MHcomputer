                    ...
                    <div class="shop-content">
                        ...
                        <div class="shop-option box-shadow mb-30 clearfix">
                            ...
                            <ul class="shop-tab f-left" role="tablist">
                                <li >
                                    <a href="index.php?controller=product&action=hsx"><i class="zmdi zmdi-view-module"></i></a>
                                </li>
                                <li class="active">
                                    <a href="index.php?controller=product&action=hsx&mode=list" ><i class="zmdi zmdi-view-list-alt"></i></a>
                                </li>
                            </ul>
                            <!-- short-by -->
                            <!-- showing -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="shop-list product-item">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <h6 class="brand-name mb-30"><?php echo $product['name_manufacturer'] ?></h6>
                        ...
                        <aside class="widget widget-categories box-shadow mb-30">
                            ...
                            <div id="cat-treeview" class="product-cat">
                                <?php foreach ($manufacturers as $manufacturer):
                                    $checked='';
                                    if(isset($_POST['hsx'])){
                                        if(in_array($manufacturer['id_manufacturer'],$_POST['hsx'])){
                                            $checked='checked';
                                        }
                                    }
                                    ?>
